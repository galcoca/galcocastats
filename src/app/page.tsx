                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background:
                        copiedEndpoint === path ? colors.secondary : 'rgba(255,255,255,0.1)',
        ...
        >
          ...
          <div style={{ display: 'grid', gap: '1.5rem' }}>
            <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
              ...
              <div>
                <h3 style={{ margin: '0 0 0.5rem 0', color: colors.text, fontWeight: 600 }}>
                  Fork the Repository
                </h3>
                <p style={{ margin: 0, opacity: 0.7, fontSize: '0.9rem' }}>
                  ...
                  >
                    github.com/galcoca/galcocastats
                  </a>{' '}
                  and click Fork
                </p>
              </div>
            ...
            <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                <p style={{ margin: 0, opacity: 0.7, fontSize: '0.9rem' }}>
                  Import your fork to Vercel and add environment variables:{' '}
                  <code
                    style={{
                      background: 'rgba(255,255,255,0.1)',
                      padding: '0.1rem 0.4rem',
            ...
            <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                <p style={{ margin: 0, opacity: 0.7, fontSize: '0.9rem' }}>
                  ...
                  in the markdown with your Vercel URL
                </p>
              </div>
            </div>
          </div>
